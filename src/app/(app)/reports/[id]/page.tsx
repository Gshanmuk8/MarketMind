      ...
      <ul className="border-t border-border">
        {items.map((item, i) => (
          <li key={i} className="flex gap-4 border-b border-border py-4">
            <span aria-hidden className="font-data text-[11px] text-faint">
  ...
  return (
    <>
      ...
      <div className="rise max-w-3xl">
        ...
        <Section label="Threats" items={sections.threats ?? []} />
        <Section label="Opportunities" items={sections.opportunities ?? []} />
